...
<center><em>The command </em>`Get-Service -Name sshd`<em> command can show that the service started successfully</em></center>
<br/>
...
<center><em>Windows Services page, with the OpenSSH Server selected</em></center>
<br/>
...
<center><em>This command does have output to show that it worked</em></center>
<br/>
<br/>
