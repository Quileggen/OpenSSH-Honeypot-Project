...
<center><em>Output of the ipconfig command. The relevant IP for this machine is 10.0.2.3</em></center>
...
<center><em>An example of connecting to a host via SSH the first time</em></center>

![A terminal shell in Kali Linux after successfully connecting to the honeypot via SSH](/img/kali_ssh_success.png)
<center><em>An established SSH connection</em></center>
